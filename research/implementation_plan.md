...
- The BTH-customized copy and `/Users/bfaris96/agentchattr` upstream checkout have diverged substantially. The upstream checkout also carries a stale local working-directory override. There is no safe single upgrade path.
